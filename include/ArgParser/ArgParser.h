#ifndef __ArgParser_Parse_h__
#define __ArgParser_Parse_h__
...
using KV = std::map<std::string, std::function<void(std::string &)>>;

void Parse(int argc, char * argv[], KV & arg_kv)
{
    auto usage = [](std::vector<std::string> const & argv, ArgParser::KV & arg_kv){
